...
const FoodDisplay = ({category}) => {
   ...
   const [lastSlice,setLastSlice] = useState(4);
    return (
        <div className=" custom-container space-y-2 py-10 ">
            ...
            <div className=" py-4 text-center"><button onClick={()=>setLastSlice(prev=>prev + 4)} className=" bg-red-500 text-white py-1 px-4 rounded cursor-pointer">Load More..</button></div>
            }
        </div>
    );
};
